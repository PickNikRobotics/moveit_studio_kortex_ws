...
TEST(BehaviorTests, test_load_behavior_plugins)
{
  ...
  BT::BehaviorTreeFactory factory;
  {
    auto plugin_instance =
        class_loader.createUniqueInstance("set_dynamixel_position::SetDynamixelPositionBehaviorsLoader");
  ...
  EXPECT_NO_THROW(
      (void)factory.instantiateTreeNode("test_behavior_name", "SetDynamixelPosition", BT::NodeConfiguration()));
}
